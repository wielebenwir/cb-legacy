  ...
  */
  public function set_defaults( $item_page, $user_bookings_page, $booking_confirmed_page, $booking_review_page  ) {
    ...
    $this->prefix.'-settings-messages' => array(
      $this->prefix.'_messages_booking_pleaseconfirm' => __( '<p> Please review your booking and click "confirm".</p>', 'commons-booking'),
      $this->prefix.'_messages_booking_confirmed' => __( '<h2>Congratulations, {{FIRST_NAME}}!</h2> <p>You´ve successfully booked {{ITEM_NAME}}. An email has been sent to your address {{USER_EMAIL}}. </p>', 'commons-booking'),
      $this->prefix.'_messages_booking_canceled' => __( '<h2>Your booking has been canceled!</h2><p>Thanks for letting us know.</p>', 'commons-booking'),      
