 ...
 * DELETE FROM wp_options WHERE option_name = 'cb_codes_table_install_data';
 *
 * to drop table and option
 * @TODO move table creation to install
 * @TODO check for Installation issues
 */



/**
 * $cb_codes_table_db_version - holds current database version
 * and used on plugin update to sync database tables
 */
global $cb_codes_table_db_version;
$cb_codes_table_db_version = '0.1'; // version changed from 1.0 to 0.1
 ...
 */
function cb_codes_table_install()
{
    global $wpdb;
    global $cb_codes_table_db_version;
    ...
    // add_option('cb_codes_table_db_version', $cb_codes_table_db_version);

    /**
     * [OPTIONAL] Example of updating to 0.1 version
     *
     * If you develop new version of plugin
     * just increment $cb_codes_table_db_version variable
 ...
 */
function cb_codes_table_install_data()
{
    global $wpdb;
...
register_activation_hook(__FILE__, 'cb_codes_table_install_data');

/**
 * Trick to update plugin database, see docs
 */
function cb_codes_table_update_db_check()
{
    global $cb_codes_table_db_version;
    if (get_site_option('cb_codes_table_db_version') != $cb_codes_table_db_version) {
        cb_codes_table_install();
    }
}

add_action('plugins_loaded', 'cb_codes_table_update_db_check');
